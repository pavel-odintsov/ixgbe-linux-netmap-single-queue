cmd_/usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_dcb_nl.o := gcc -Wp,-MD,/usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/.ixgbe_dcb_nl.o.d  -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/src/linux-headers-3.16.0-4-common/arch/x86/include -Iarch/x86/include/generated  -I/usr/src/linux-headers-3.16.0-4-common/include -Iinclude -I/usr/src/linux-headers-3.16.0-4-common/arch/x86/include/uapi -Iarch/x86/include/generated/uapi -I/usr/src/linux-headers-3.16.0-4-common/include/uapi -Iinclude/generated/uapi -include /usr/src/linux-headers-3.16.0-4-common/include/linux/kconfig.h   -I/usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe -D__KERNEL__ -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -m64 -mno-mmx -mno-sse -mno-80387 -mno-fp-ret-in-387 -mpreferred-stack-boundary=3 -mtune=generic -mno-red-zone -mcmodel=kernel -funit-at-a-time -maccumulate-outgoing-args -DCONFIG_X86_X32_ABI -DCONFIG_AS_CFI=1 -DCONFIG_AS_CFI_SIGNAL_FRAME=1 -DCONFIG_AS_CFI_SECTIONS=1 -DCONFIG_AS_FXSAVEQ=1 -DCONFIG_AS_CRC32=1 -DCONFIG_AS_AVX=1 -DCONFIG_AS_AVX2=1 -pipe -Wno-sign-compare -fno-asynchronous-unwind-tables -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -mno-avx -fno-delete-null-pointer-checks -O2 -Wframe-larger-than=2048 -fstack-protector -Wno-unused-but-set-variable -fno-var-tracking-assignments -g -pg -mfentry -DCC_USING_FENTRY -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -Werror=implicit-int -Werror=strict-prototypes -DCC_HAVE_ASM_GOTO -mcmodel=kernel -mno-red-zone -DDRIVER_IXGBE -DDRIVER_NAME=ixgbe -DDRIVER_NAME_CAPS=IXGBE -DLINUX -D__KERNEL__ -DMODULE -O2 -pipe -Wall   -I/lib/modules/3.16.0-4-amd64/source/include -D__SMP__  -DMODULE  -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(ixgbe_dcb_nl)"  -D"KBUILD_MODNAME=KBUILD_STR(ixgbe)" -c -o /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/.tmp_ixgbe_dcb_nl.o /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_dcb_nl.c

source_/usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_dcb_nl.o := /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_dcb_nl.c

deps_/usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_dcb_nl.o := \
    $(wildcard include/config/dcb.h) \
    $(wildcard include/config/fcoe.h) \
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe.h \
  ...
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_dcb.h \
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_type.h \
    $(wildcard include/config/ptr.h) \
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_osdep.h \
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/kcompat.h \
  ...
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_mbx.h \
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_osdep2.h \
  ...
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_fcoe.h \
  ...
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_api.h \
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_common.h \
  ...
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_dcb_82598.h \
  /usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_dcb_82599.h \

/usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_dcb_nl.o: $(deps_/usr/src/fake_linux_kernel_sources/drivers/net/ethernet/intel/ixgbe/ixgbe_dcb_nl.o)
